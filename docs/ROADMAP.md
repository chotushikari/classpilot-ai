...
| 2 | Persistent assignment watcher | Poll course work independently of Chrome, fingerprint snapshots, deduplicate jobs, honor due-date priority, lease targets, and recover from source failures. |
