...
4. Sprint 1 course sync needs `classroom.courses.readonly`; coursework listing for the signed-in student needs `classroom.coursework.me.readonly`. The previously configured submission-only read scope cannot list coursework. [courses.list](https://developers.google.com/workspace/classroom/reference/rest/v1/courses/list) and [courseWork.list](https://developers.google.com/workspace/classroom/reference/rest/v1/courses.courseWork/list)
